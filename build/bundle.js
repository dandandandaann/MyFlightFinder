...
var app = (function () {
            ...
            for (let day = 1; day <= totalDays; day++) {
                if (fares.calendarDayList[day - 1] && fares.calendarDayList[day - 1].miles) {
                    ...
                    if (divSmiles.innerText) {
                        let divToolTip = divMiles.querySelector('.tooltiptext');
                        if (!divToolTip) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$1, 136, 8, 5753);
    			attr_dev(span0, "id", "month");
    			add_location(span0, file$1, 137, 8, 5801);
    			attr_dev(span1, "id", "year");
    			add_location(span1, file$1, 138, 8, 5830);
    			attr_dev(a1, "id", "right");
    			attr_dev(a1, "class", "right-arrow");
    			add_location(a1, file$1, 139, 8, 5858);
    			attr_dev(h1, "class", "calendar-title");
    			add_location(h1, file$1, 135, 4, 5716);
    			add_location(div0, file$1, 134, 0, 5705);
    			attr_dev(table, "class", "calendar-table");
    			add_location(table, file$1, 144, 8, 5963);
    			attr_dev(div1, "class", "");
    			add_location(div1, file$1, 143, 4, 5939);
    			attr_dev(div2, "class", "");
    			add_location(div2, file$1, 142, 0, 5919);
    		},
    ...
    function create_each_block_1(ctx) {
    	let option;
    	let t0_value = /*month*/ ctx[13].text + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			option.__value = /*month*/ ctx[13].value;
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 72, 5, 1827);
    			attr_dev(label, "for", "isTesting");
    			add_location(label, file, 73, 5, 1888);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*isRunningLocally*/ ctx[3] && create_if_block(ctx);

    	function calendar_1_isRunningLocally_binding(value) {
    		/*calendar_1_isRunningLocally_binding*/ ctx[9](value);
    	}

    	let calendar_1_props = {
    		origin: /*orginAirportInput*/ ctx[4],
    		destination: /*destinationAirportInput*/ ctx[5],
    		month: /*monthInput*/ ctx[0],
    		year: /*yearInput*/ ctx[1]
    	};

    	if (/*isRunningLocally*/ ctx[3] !== void 0) {
    		calendar_1_props.isRunningLocally = /*isRunningLocally*/ ctx[3];
    	}

    	calendar_1 = new Calendar({ props: calendar_1_props, $$inline: true });
    	/*calendar_1_binding*/ ctx[8](calendar_1);
    	...
    	const block = {
    		c: function create() {
    			...
    			if (/*monthInput*/ ctx[0] === void 0) add_render_callback(() => /*select0_change_handler*/ ctx[6].call(select0));
    			add_location(select0, file, 30, 4, 750);
    			set_style(select1, "width", "100px");
    			if (/*yearInput*/ ctx[1] === void 0) add_render_callback(() => /*select1_change_handler*/ ctx[7].call(select1));
    			...
    			input0.value = /*orginAirportInput*/ ctx[4];
    			set_style(input0, "width", "80px");
    			add_location(input0, file, 45, 4, 1180);
    			add_location(br1, file, 52, 4, 1326);
    			attr_dev(label1, "for", "searchDestination");
    			add_location(label1, file, 53, 4, 1338);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "searchDestination");
    			set_style(input1, "width", "200px");
    			add_location(input1, file, 55, 5, 1436);
    			set_style(div0, "display", "none");
    			add_location(div0, file, 54, 4, 1401);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "maxlength", "3");
    			attr_dev(input2, "id", "destinationAirportCode");
    			input2.value = /*destinationAirportInput*/ ctx[5];
    			set_style(input2, "width", "80px");
    			add_location(input2, file, 61, 4, 1547);
    			add_location(br2, file, 68, 4, 1704);
    			add_location(br3, file, 68, 10, 1710);
    			add_location(button, file, 69, 4, 1722);
    			add_location(br4, file, 70, 4, 1786);
    			...
    			add_location(a2, file, 91, 2, 2226);
    			add_location(p1, file, 89, 1, 2194);
    			attr_dev(a3, "href", "https://github.com/orderedlist");
    			add_location(a3, file, 95, 2, 2342);
    			add_location(p2, file, 93, 1, 2298);
    			add_location(footer, file, 88, 0, 2183);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			select_option(select0, /*monthInput*/ ctx[0]);
    			append_dev(div1, t8);
    			...
    			select_option(select1, /*yearInput*/ ctx[1]);
    			append_dev(div1, t9);
    			append_dev(div1, br0);
    			append_dev(div1, t10);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*calendar*/ ctx[2].searchFares)) /*calendar*/ ctx[2].searchFares.apply(this, arguments);
    						},
    						false,
    						false,
    						false
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*monthInput, monthList*/ 1) {
    				select_option(select0, /*monthInput*/ ctx[0]);
    			}
    			...
    			if (dirty & /*yearInput, yearList*/ 2) {
    				select_option(select1, /*yearInput*/ ctx[1]);
    			}

    			if (/*isRunningLocally*/ ctx[3]) {
    				if (if_block) ; else {
    			...
    			if (dirty & /*monthInput*/ 1) calendar_1_changes.month = /*monthInput*/ ctx[0];
    			if (dirty & /*yearInput*/ 2) calendar_1_changes.year = /*yearInput*/ ctx[1];

    			if (!updating_isRunningLocally && dirty & /*isRunningLocally*/ 8) {
    				updating_isRunningLocally = true;
    				calendar_1_changes.isRunningLocally = /*isRunningLocally*/ ctx[3];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function select0_change_handler() {
    		...
    		$$invalidate(0, monthInput);
    	}

    	function select1_change_handler() {
    		yearInput = select_value(this);
    		$$invalidate(1, yearInput);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('orginAirportInput' in $$props) $$invalidate(4, orginAirportInput = $$props.orginAirportInput);
    		if ('destinationAirportInput' in $$props) $$invalidate(5, destinationAirportInput = $$props.destinationAirportInput);
    		if ('monthInput' in $$props) $$invalidate(0, monthInput = $$props.monthInput);
    		if ('yearInput' in $$props) $$invalidate(1, yearInput = $$props.yearInput);
    		if ('calendar' in $$props) $$invalidate(2, calendar = $$props.calendar);
    		if ('isRunningLocally' in $$props) $$invalidate(3, isRunningLocally = $$props.isRunningLocally);
    	};
